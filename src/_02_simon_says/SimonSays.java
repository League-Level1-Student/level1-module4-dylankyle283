...
JOptionPane.showMessageDialog(null, "Press the key simon says to, if he doesn't say press a different key");
...
if (simonSays  == true  && imageIndex == 38  ) {
	points ++;
tries ++;
}
else if (simonSays  == true  && imageIndex == 39  ) {
	points ++;
tries ++;
}
else if (simonSays  == true  && imageIndex == 40  ) {
	points ++;
tries ++;
}
else if (simonSays  == true  && imageIndex == 37  ) {
	points ++;
tries ++;
}
else {
...
boolean simonSays = rand.nextBoolean();
		if (simonSays == true) {
